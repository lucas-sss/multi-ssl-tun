...
extern "C"
{
    ...
    extern const unsigned char RECORD_TYPE_CONTROL_AUTH_CONFIG[RECORD_TYPE_LABEL_LEN];  // vpn账号配置信息
    extern const unsigned char RECORD_TYPE_CONTROL_NOTICE[RECORD_TYPE_LABEL_LEN];       // vpn下线、顶替通知
    ...
    extern const unsigned char RECORD_TYPE_BEATS[RECORD_TYPE_LABEL_LEN];                // vpn心跳协议
    extern const unsigned char RECORD_TYPE_SEND_QUERY_SMS[RECORD_TYPE_LABEL_LEN];       // 发送短信协议
    extern const unsigned char RECORD_TYPE_MODIFY_PWD[RECORD_TYPE_LABEL_LEN];           // 修改密码协议
    extern const unsigned char RECORD_TYPE_NET2NET[RECORD_TYPE_LABEL_LEN];              // 网对网专用协议
    extern const unsigned char RECORD_TYPE_NET2NET_TUN_CONFIG[RECORD_TYPE_LABEL_LEN];   // 网对网虚拟网卡配置协议
    extern const unsigned char RECORD_TYPE_NET2NET_HEARTBEATS[RECORD_TYPE_LABEL_LEN];   // 网对网心跳协议
    extern const unsigned char RECORD_TYPE_NET2NET_CONFIG[RECORD_TYPE_LABEL_LEN];       // 网对网配置协议
