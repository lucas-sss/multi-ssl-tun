...
extern "C"
{
    ...
    const unsigned char RECORD_TYPE_CONTROL_AUTH_CONFIG[RECORD_TYPE_LABEL_LEN] = {0x12, 0x13};  // vpn账号配置信息
    const unsigned char RECORD_TYPE_CONTROL_NOTICE[RECORD_TYPE_LABEL_LEN] = {0x12, 0x14};       // vpn下发消息通知(客户端顶替通知、强制下线通知等)
    ...
    const unsigned char RECORD_TYPE_BEATS[RECORD_TYPE_LABEL_LEN] = {0x15, 0x10};                // vpn心跳协议
    const unsigned char RECORD_TYPE_SEND_QUERY_SMS[RECORD_TYPE_LABEL_LEN] = {0x16, 0x10};       // 发送短信协议
    const unsigned char RECORD_TYPE_MODIFY_PWD[RECORD_TYPE_LABEL_LEN] = {0x17, 0x10};           // 修改密码协议

    const unsigned char RECORD_TYPE_NET2NET[RECORD_TYPE_LABEL_LEN] = {0x20, 0x10};              // 网对网专用协议
    const unsigned char RECORD_TYPE_NET2NET_TUN_CONFIG[RECORD_TYPE_LABEL_LEN] = {0x20, 0x11};   // 网对网虚拟网卡配置协议
    const unsigned char RECORD_TYPE_NET2NET_HEARTBEATS[RECORD_TYPE_LABEL_LEN] = {0x20, 0x12};   // 网对网心跳协议
    const unsigned char RECORD_TYPE_NET2NET_CONFIG[RECORD_TYPE_LABEL_LEN] = {0x20, 0x13};       // 网对网配置协议
